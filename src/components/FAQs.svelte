...
<SectionWrapper id="faqs">
	<div class="flex flex-1 flex-col items-center justify-center gap-10 py-10 sm:gap-14 md:gap-24">
		...
		<div class="flex w-full flex-col gap-8 sm:gap-10 md:gap-14">
			{#each faqs as faq, index}
				<div class="relative mx-auto flex w-full max-w-[800px] flex-col gap-2 px-6 py-4 text-left">
					<div class="absolute inset-0 h-[1px] w-1/3 -translate-x-4 bg-slate-950"></div>
					<div class="absolute inset-0 h-2/3 w-[1px] -translate-y-4 bg-slate-950"></div>
					<h4 class="pt-2 text-lg sm:text-xl md:text-2xl">{faq.question}</h4>
